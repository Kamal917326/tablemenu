...
export const seedRestaurants: Record<string, Restaurant> = {
  "copper-pot": {
    slug: "copper-pot",
    name: "The Copper Pot",
    tagline: "Modern British · Shoreditch",
    address: "42 Rivington Street, London EC2A 3DU",
    tableCount: 12,
    categories: [
    ...
    dishes: [
      {
        ...
        description: "San Marzano tomatoes, basil oil, sourdough croutons.",
        pricePence: 750,
        categoryId: "starters",
        imageUrl:
      ...
      },
      {
        ...
        description: "Crisp skin salmon, heritage carrots, lemon beurre blanc.",
        pricePence: 1895,
        categoryId: "mains",
        imageUrl:
          "https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800&q=80",
        calories: 520,
        portion: "180g fillet + sides",
        ingredients: [
          "salmon",
          "butter",
          "cream",
      ...
      },
      {
        ...
        description: "Dry-aged beef, aged cheddar, brioche, house pickles.",
        pricePence: 1650,
        categoryId: "mains",
        imageUrl:
          "https://images.unsplash.com/photo-1568901347635-c89af620d937?w=800&q=80",
        calories: 890,
        portion: "220g patty",
        ingredients: [
          "beef",
      ...
      },
      {
        ...
        description: "Valrhona chocolate, salted caramel, vanilla ice cream.",
        pricePence: 850,
        categoryId: "desserts",
        imageUrl:
      ...
      },
      {
        ...
        description: "Single-origin blend, roasted in Hackney.",
        pricePence: 320,
        categoryId: "drinks",
        imageUrl:
          "https://images.unsplash.com/photo-1514432324607-09a988783f4c?w=800&q=80",
        calories: 5,
        portion: "60ml",
...
export const demoRestaurant = seedRestaurants["copper-pot"];
